...
const HERO_SLIDES = [
  ...
  { id: 3, title: "Forgot Something?", subtitle: "Charger, toothbrush, or noodles — we got you.", image: "https://images.unsplash.com/photo-1529070538774-1843cb3265df?q=80&w=2070", cta: "Shop Essentials", color: "#FF6B2C" },
];
...
const MOCK_USUALS = [
  ...
  { id: 'u7', name: 'Type-C Cable', orders: 7, price: 149, image: 'https://images.unsplash.com/photo-1583863788434-e58a36330cf0?q=80&w=400' },
...
const FORGOT_ITEMS = [
  ...
  { id: 'f3', name: 'Charger', emoji: '🔌', price: 149 },
...
const CATEGORIES = [
  ...
  { name: 'Electronics', emoji: '🔌', color: '#9C27B0' },
